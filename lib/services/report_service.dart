...
final class ReportService {
  ...
  void printReport(DiagnosticReport report) {
    ...
    for (final result in report.results) {
      ...
      for (final issue in result.issues) {
        terminal.writeLine('    ${issue.severity.emoji} [${issue.code}] ${issue.title}');
      }
    }
    terminal.writeLine('');
  }
  ...
  String toJson(DiagnosticReport report) {
    final map = {
      ...
      if (report.firebaseVersion != null) 'firebaseVersion': report.firebaseVersion,
      'results': report.results.map((r) => {
        ...
        'issues': r.issues.map((i) => {
          ...
          if (i.recommendation != null) 'recommendation': i.recommendation,
  ...
  Future<void> saveReport(DiagnosticReport report, FileSystem fs, String outputPath) async {
